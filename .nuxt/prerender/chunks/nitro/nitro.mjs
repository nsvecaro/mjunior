import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getResponseStatus, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, getHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL, withoutProtocol, withTrailingSlash, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/radix3/dist/index.mjs';
import { toValue } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve as resolve$1, basename, isAbsolute } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/@iconify/utils/lib/index.mjs';
import { consola, createConsola } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/consola/dist/index.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/noel/Desktop/ModingJuniorWeb/server/assets"}];
 ...
 */
const _47Users_47noel_47Desktop_47ModingJuniorWeb_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47utils_47cache_45driver_46js = defineDriver((opts) => {
...
storage.mount('internal:nuxt:prerender', _47Users_47noel_47Desktop_47ModingJuniorWeb_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47utils_47cache_45driver_46js({"driver":"/Users/noel/Desktop/ModingJuniorWeb/node_modules/nuxt/dist/core/runtime/nitro/utils/cache-driver.js","base":"/Users/noel/Desktop/ModingJuniorWeb/.nuxt/cache/nitro/prerender"}));
storage.mount('data', fsDriver({"driver":"fsLite","base":"./.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/noel/Desktop/ModingJuniorWeb","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/noel/Desktop/ModingJuniorWeb/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/noel/Desktop/ModingJuniorWeb/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/noel/Desktop/ModingJuniorWeb/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "7580f06f-7ec4-469b-8ecb-111db12749ce",
    ...
    "routeRules": {
      ...
      "/sitemap.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2025-08-04T09:26:29.694Z"
        }
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/noel/Desktop/ModingJuniorWeb/public"
      ]
    },
    "http": {
      "domains": []
...
const _tzDuMtwKlcf3qZDuupPDizfwXCOpeWJzi7zpQRoKd_I = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _tzDuMtwKlcf3qZDuupPDizfwXCOpeWJzi7zpQRoKd_I
];

const assets = {
  "/200.html": {
    "type": "text/html; charset=utf-8",
    "etag": "\"76e-06InnjWRuweDcQBnS9+0KVG5tgM\"",
    "mtime": "2025-08-04T09:26:33.076Z",
    "size": 1902,
  ...
  "/_payload.json": {
    ...
    "etag": "\"45-QCmlSjrhl1ZTRsOfNk5NjwLmNAQ\"",
    "mtime": "2025-08-04T09:26:33.103Z",
    "size": 69,
    "path": "../../.output/public/_payload.json"
  },
  "/index.html": {
    "type": "text/html; charset=utf-8",
    "etag": "\"a868-vAj9lvK9NG8T6NbhE5Vmavmrs2g\"",
    "mtime": "2025-08-04T09:26:33.090Z",
    "size": 43112,
    "path": "../../.output/public/index.html"
  },
  "/galerija/_payload.json": {
    "type": "application/json",
    "etag": "\"45-LmkYcii+nfDNQES3Sa2uOWNytqQ\"",
    "mtime": "2025-08-04T09:26:33.116Z",
    "size": 69,
    "path": "../../.output/public/galerija/_payload.json"
  },
  "/galerija/index.html": {
    "type": "text/html; charset=utf-8",
    "etag": "\"334c-i2NfxkNJOXymEZJpCIvhrDK9KRI\"",
    "mtime": "2025-08-04T09:26:33.108Z",
    "size": 13132,
    "path": "../../.output/public/galerija/index.html"
  },
  "/hvala/_payload.json": {
    "type": "application/json",
    "etag": "\"45-LmkYcii+nfDNQES3Sa2uOWNytqQ\"",
    "mtime": "2025-08-04T09:26:33.116Z",
    "size": 69,
    "path": "../../.output/public/hvala/_payload.json"
  },
  "/hvala/index.html": {
    "type": "text/html; charset=utf-8",
    "etag": "\"2dbf-a51ilid422Ri45rEKw8CVPkGDiM\"",
    "mtime": "2025-08-04T09:26:33.108Z",
    "size": 11711,
    "path": "../../.output/public/hvala/index.html"
  },
  "/proizvodi/_payload.json": {
    "type": "application/json",
    "etag": "\"45-LmkYcii+nfDNQES3Sa2uOWNytqQ\"",
    "mtime": "2025-08-04T09:26:33.116Z",
    "size": 69,
    "path": "../../.output/public/proizvodi/_payload.json"
  },
  "/proizvodi/index.html": {
    "type": "text/html; charset=utf-8",
    "etag": "\"3de6-eRnZNLb4W0Ek3+FVJ/15/IO11a8\"",
    "mtime": "2025-08-04T09:26:33.108Z",
    "size": 15846,
    "path": "../../.output/public/proizvodi/index.html"
  }
};
...
const _d3AHcm = eventHandler((event) => {
...
const _vjidFn = defineCachedEventHandler(async (event) => {
...
const _zKKMnM = eventHandler(async (e) => {
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file:///Users/noel/Desktop/ModingJuniorWeb/node_modules/fast-xml-parser/src/fxp.js');
...
const _oVtKM1 = defineEventHandler(async (e) => {
...
const _hZZ8uM = lazyEventHandler(() => {
...
const _lazy_9fD7MG = () => import('../_/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _d3AHcm, lazy: false, middleware: true, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _vjidFn, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _zKKMnM, lazy: false, middleware: true, method: undefined },
  { route: '/sitemap.xml', handler: _oVtKM1, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _hZZ8uM, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_9fD7MG, lazy: true, middleware: false, method: undefined }
];
